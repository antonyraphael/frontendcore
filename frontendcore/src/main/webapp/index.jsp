...
.fade-carousel .slides .slide-1 {
  background-image: url(https://fortunedotcom.files.wordpress.com/2014/08/rwh1777.jpg); 
}
.fade-carousel .slides .slide-2 {
  background-image: url(https://roxys.com/wp-content/uploads/2016/09/50-guitar-sale.jpg);
}
.fade-carousel .slides .slide-3 {
  background-image: url(http://www.joyfulsounds.ca/wp-content/uploads/2018/09/muziekwinkel-sint-niklaas-gitaarwinkel.jpg);
}
                    ...
                    <div class="item slides active">
                        <div class="slide-1"></div>
                            <div class="hero">
                                <hgroup>
                                    <h1>Welcome...!!</h1>        
                                    <h3>Take Your Creativity To The Next Level</h3>
                                </hgroup>
                    ...
                    <div class="item slides">
                        ...
                        <div class="item slides">
                            <div class="slide-3"></div>
                                <div class="hero">        
                                    <hgroup>
                                        <h1>Catch Your Dreams with Great Deals</h1>        
                                    </hgroup>
                                    </div>
                            </div>
                        </div> 
